...
import 'package:help_ukraine_widget/src/widgets/help_ukraine_widget/animated_view_transition.dart';
...
class HelpUkraineWidget extends StatelessWidget {
  ...
  final TraverseController<HelpUkraineWidgetView> _controller;

  ///Constructor
  const HelpUkraineWidget({
    Key? key,
    required this.collapsedView,
    required this.optionsView,
    required this.mainView,
    required TraverseController<HelpUkraineWidgetView> controller,
  ...
  Widget build(BuildContext context) {
    final viewMap = {
      HelpUkraineWidgetView.collapsed: collapsedView,
      HelpUkraineWidgetView.main: mainView,
      HelpUkraineWidgetView.options: optionsView,
    };
